...
West, Copyright 2015 
West is licensed under GNU General Public License V2 or later. You can find a copy of it in the license.txt file.
...
f) Images folder
The image is also used in screenshot.
Copyright: Unsplash
Resource URI: https://pixabay.com/en/apple-macbook-laptop-computer-691798/
License: CC0 1.0
